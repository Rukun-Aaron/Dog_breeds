...
class_labels = ['Afghan Hound', 'Basset Hound','Beagle', 'Bearded Collie', 'Bernese Mountain Dog', 'Bloodhound', 'Border Collie',
                'Boston Terrier', 'Boxer', 'Bulldog', 'Chihuahua',  'Chow Chow', 'Pembroke Welsh Corgi', 'Coyote', 'Doberman Pinscher', 
                'French Bulldog', 'German Shepherd', 'Golden Retriever', 'Great Dane', 'Great Pyrenees', 'Greyhound', 'Irish Water Spaniel', 
                'Japanese Chin', 'Komondor', 'Labradoodle', 'Labrador Retriever', 'Belgian Malinois', 'Maltese', 'Newfoundland', 'Pekingese', 
                'Pit Bull', 'Pomeranian', 'Poodle','Pug', 'Rottweiler', 'Saint Bernard', 'Shiba Inu', 'Shih Tzu', 'Siberian Husky', 'Yorkshire Terrier']       
