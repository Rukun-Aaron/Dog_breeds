  ...
  return (
    <div className="w-full h-full flex justify-center overflow-x-hidden pt-4 pb-4">
      <div className="max-w-4xl xl:max-w-5xl w-11/12 flex flex-col items-center h-full gap-4">
        ...
        {showModal && (
          <div className=" fixed z-20 top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center font-outfit">
            <div className="relative  bg-white p-4 rounded-md  sm:w-full sm:h-48 md:w-9/12 md:h-[45rem] lg:h-[42rem] xl:h-[33rem] 2xl:h-[46rem] text-center overflow-y-auto">
