                ...
                <div className="z-50 fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center  items-center font-outfit">
                    <div className="relative  bg-white p-10 m-2 rounded-2xl  h-[80%] min-w-[320px] aspect-9/16 sm sm:aspect-auto  md:h-[80%] lg:aspect-video  lg:h-[40rem] xl:h-[44rem]  text-center overflow-y-auto">
                        <div className='flex flex-row justify-center'>
                            <span className="text-3xl font-bold mb-4 text-center">What is it like owning a <span className="text-[#694DDB]"> {predictions[selectedPredictionIndex].label}? </span></span>
                            <button
                                onClick={handleClose}
                                type="button"
                        ...
                        {selectedPredictionIndex !== null && (
                            <div className="py-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-gray-700 justify-center">
                                <div className="flex justify-center px-5 py-4 col-span-1 col-start-1 row-start-1 lg:col-start-1 ">
                                ...
                                <div className='flex justify-center pt-4 sm:col-span-2 sm:mt-3 col-start-1 lg:col-span-1 lg:col-start-2'>
                                    <p className='text-lg'>{predictions[selectedPredictionIndex].label}  Characteristics</p>
                                ...
                                {breedInfo && (
                                    ...
                                    <div className="flex justify-center col-start-1 aspect-square h-full w-full sm:col-span-2 sm:h-auto sm:w-auto lg:col-span-1 lg:row-start-2 lg:row-span-2 lg:col-start-2">

                                        <Radar
                                            className='w-[100%] h-[100%] flex-grow'
                                            data={{
                                ...
                                {selectedBreedInfo[0] ? (
                                    <div className="flex justify-center px-5 py-4 col-start-1 row-start-5 sm:col-start-2 sm:row-start-2  lg:py-0 lg:row-start-2 lg:col-start-3">
                                        <img
                                    ...
                                    <div className="flex justify-center px-5 py-4 col-start-1 row-start-5 sm:col-start-2 sm:row-start-2 lg:row-start-2 lg:col-start-3 ">
                                        <img
                                ...
                                }
                                {
                                    selectedBreedInfo.length > 0 && (
                                        <div className='flex flex-col py-4 justify-center col-start-1 row-start-6 sm:row-start-3 sm:col-start-2 lg:row-start-3 lg:col-start-3'>
                        ...
                        <button
                            className="btn btn-ghost bg-[#694DDB] text-white px-12 rounded-full mt-16 inline-block lg:hidden"
                            onClick={handleClose}>
                            Close
                        </button>
                    </div>
