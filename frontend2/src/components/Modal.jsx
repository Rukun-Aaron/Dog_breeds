                    ...
                    <div className="relative  bg-white p-4 m-2 rounded-2xl  h-[80%] min-w-[320px] aspect-9/16 sm sm:aspect-auto  md:h-[80%] lg:aspect-video  lg:h-[40rem] xl:h-[44rem]  text-center overflow-y-auto">
                        ...
                        {selectedPredictionIndex !== null && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-gray-700 justify-center content-center ">
                                ...
                                <div className='flex items-center justify-center px-5 sm:col-span-2 sm:mt-3 lg:col-span-1 lg:col-start-2'>
                                    <p>{predictions[selectedPredictionIndex].label}  Characteristics</p>

                                </div>
                                <div className="dropdown dropdown-bottom flex  justify-center items-center px-5  sm:row-start-1 sm:col-start-2  lg:row-start-1 lg:col-start-3">
                                    <div tabIndex={0} role="button" className="btn w-48 " onClick={toggleDropdown}>
                                ...
                                {breedInfo[selectedPredictionIndex][0] && (
                                    ...
                                    <div className=" flex items-center justify-center content-center col-start-1 sm:col-span-2 lg:col-span-1 lg:row-start-2  lg:col-start-2">

                                        <Radar
                                            className='p-2 h-56 w-56 lg:w-full lg:h-full'
                                            data={{
                                ...
                                {selectedBreedImage ? (
                                    <div className="flex items-center justify-center z-[1] px-5  py-2  sm:row-start-2 lg:row-start-2 lg:col-start-3">
                                        <img
                                ...
                                <div className=' flex  flex-col row-start-3  lg:col-start-1 justify-center '>
                                ...
                                </div>
                                {
                                    selectedBreedInfo.length > 0 && (
                                        <div className='flex  flex-col justify-center col-start-1 row-start-3 sm:col-start-2 lg:row-start-3 lg:col-start-3'>
