...
const Modal2 = ({ showModal, handleModalClose, selectedIndex, breeds, breedInfo }) => {
    ...
    useEffect(() => {
        ...
        //     console.log(breeds);
        //     console.log(predictions[selectedIndex].label);
        //     const defaultIndex = breeds.findIndex(breed => breed.label === predictions[selectedIndex].label);
